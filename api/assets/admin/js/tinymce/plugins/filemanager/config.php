...
//$base_url="http://localhost/sistar"; //url base of site if you want only relative url leave empty
$base_url=""; //url base of site if you want only relative url leave empty
$upload_dir = '/sistar/uploads/'; // path from base_url to upload base dir
